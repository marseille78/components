/**
 *
 * @param elSelector {Element} - Селектор элемента, из которого будем делать Funny Select
 * @param obj {Object} - Объект параметров
 * @returns {Object}
 * @constructor
 */
function FunnySelect(elSelector, obj) {
    var o = new Object();
    o.elSelector = elSelector;// {String} - Селектор экземпляра объекта
    o.fieldName = obj.fieldName;// {String} - Значение атрибута (name) для поля ввода

    /**
     * Метод. Инициализация экземпляра объекта по его селектору
     */
    o.init = function() {
        /**
         * Данные для инициализации
         * currentEl {Object} - Объект элементов, из которых будем делать Funny Select. Ключами элементов будут индексы
         * currentData {Object} - Объект с данными для каждого селекта в соответствии с индексом
         */
        var currentEl = {};
        var currentData = {};
        ...
        var self = this;// Ссылка на контекст экземпляра объекта
        var i = 0;// Индекс текущего элемента на текущей инициализации.
        ...
        /**
         * Инициализация текущего элемента Funny Select
         * currentEl[i] {Element} - Элемент
         */
